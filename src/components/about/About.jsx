      ...
      <div className="container">
        ...
        <div className="text-section-container">
          <Card body className="card">
            ...
            <p>Hi! I'm Ryan from South Korea.</p>
            <p>I am a computer science major and I am interested in getting to learn more about web development.</p>
            <p>
              I was originally a '24 but I left to serve in the Korean army for 18 months after sophomore year and now I am back as a '26!
            </p>
          </Card>
        </div>
      </div>
